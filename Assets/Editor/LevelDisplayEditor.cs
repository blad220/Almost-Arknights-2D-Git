...
{
    [CustomEditor(typeof(LevelDisplay))]
    public class LevelDisplayEditor : Editor
    {
        ...
        void OnEnable()
        {
            ...
            EditorUtility.SetDirty(serializedObject.FindProperty("levelData").serializedObject.targetObject);
        }
