...
namespace Enemy.EnemySpawn
{
    ...
    public class EnemySpawner : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            BezierPath bezierPath = CreatePath(StartPointObject, IntermediatePoints, EndPointObject);
        ...
        private void CreateEnemy(GameObject enemyObject, GameObject parent, PathCreator path)
        {
            ...
            EnemyControll.EnemyController enemyController;

            if (enemy.TryGetComponent(out EnemyControll.EnemyController _enemyController))
            {
                enemyController = _enemyController;
            }
            else
            {
                enemyController = enemy.AddComponent<EnemyControll.EnemyController>();
            }
